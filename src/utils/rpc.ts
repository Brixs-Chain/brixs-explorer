...
export const RPC_URL = import.meta.env.VITE_RPC_URL || 'https://brixs-core-node.onrender.com';
export const EXPLORER_API = import.meta.env.VITE_EXPLORER_API || 'https://brixs-core-node.onrender.com';
